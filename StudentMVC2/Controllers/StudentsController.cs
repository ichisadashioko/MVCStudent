...
using StudentMVC2.Models;

namespace StudentMVC2.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "ID,FirstName,LastName,DoB,Gender")] Student student)
        {
        ...
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "ID,FirstName,LastName,DoB,Gender")] Student student)
        {
            if (ModelState.IsValid)
            {
